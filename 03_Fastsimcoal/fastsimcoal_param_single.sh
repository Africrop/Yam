...
###################################################################################################################################
# This script simulates the scenario described in Single.est and Single.tlp
# Usage: qsub fastsimcaol_param_single.sh $1
# $1 = name of the model to test (example files: $1=Single)
# Require in the same folder the files $1.obs, $1.est and $1.tpl (example files: Single.obs, Single.est, Single.tlp)
####################################################################################################################################
